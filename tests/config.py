...
This module provides shared configuration for all test modules,
...
GOLDEN_DATASETS_DIR = FIXTURES_DIR / "golden_datasets"
SYSTEM_TEST_CASES_DIR = FIXTURES_DIR / "system_test_cases"

# Evaluation directories
EVALUATION_DIR = TESTS_ROOT / "evaluation"
EVALUATION_REPORTS_DIR = EVALUATION_DIR / "reports"

# Ensure directories exist
RESULTS_DIR.mkdir(exist_ok=True, parents=True)
EVALUATION_REPORTS_DIR.mkdir(exist_ok=True, parents=True)
